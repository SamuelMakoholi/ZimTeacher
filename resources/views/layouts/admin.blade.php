    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">ZimTeachers</div>
            </a>
            ...
            <!-- Nav Item - By Admin -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.transfer')}}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('admin.leave.report')}}">Leaves</a>
                        <a class="collapse-item" href="{{ route('admin.leave.transfer')}}">Transfers</a>
                    </div>
                </div>
            </li>
...
{{-- 
            ...
            @if (Auth::user()->hasRole('user'))
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('home.teacher')}}">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>Dashboard</span></a>
                </li>
                <li class="nav-item">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Zim Teachers Transferes</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
